 ...
 */
class Memberform extends Addons
{
    public $info = [
        'name' => 'memberform',
        'title' => '会员系统',
    ...
    {
      $this->dosqlfile(ADDONS_PATH.'memberform/install.sql');
      return true;
    }
     ...
     */
     public function uninstall(){
        $this->dosqlfile(ADDONS_PATH.'memberform/uninstall.sql');
        return true;
     }
     ...
     * @return mixed
     */
    public function memberformhook($param)
    {
